...
> ![](images/professoroctopus.png) While it is possible to have deployments with or without a tenant it something we recommend.  The project should either require tenants or not allow tenants.  Having a project with or without a tenant makes it very confusing to most users, which increases the chances of someone making a mistake.
